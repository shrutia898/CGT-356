...
<head>
	...
	<style type="text/css">
		...
		fieldset{ padding:10px; border:1px solid #ccc; width:400px; overflow:auto; margin:30px;}
		...
		div#errorMsg{color: red; font-weight:bold; font-size:12pt; position:absolute; top:420px; left:480px;}
	</style>
</head>
<body>
<h1 style="font-size:14pt; text-indent:360px;">Assign 04 - Index Page</h1>
	<caption><a href="index2.php">Click here to go to index2.php</a></caption> <br />
...
<form id="form0" method="post" action="storeInfo.php"> 
        ...
        <ul>
            <li> <label title="Name" for="name">Name <span>*</span></label> 
				<input type="text" name="name" id="name" size="30" maxlength="30" 
					   value="<?php if(!empty($_SESSION["name"])){echo($_SESSION["name"]);}?>"/></li>
            ...
            <li> <label title="Zip" for="zip">Zip Code <span>*</span></label> 
    ...
    <fieldset id="shipping">
        ...
        <ul>
            ...
            <li> <label title="SZip" for="Szip">Zip Code </label> 
            ...
            <li> <label title="SCountry" for="Scountry">Country </label> 
				<input type="text" name="Scountry" id="Scountry" size="30" maxlength="30" 
					  value="<?php if(!empty($_SESSION["Scountry"])){echo($_SESSION["Scountry"]);}?>"/></li>
        </ul>
    </fieldset>
    <fieldset id="submit">
