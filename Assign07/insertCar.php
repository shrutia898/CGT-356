...
<form id="form0" method="post" action="doInsertCar.php">
	<fieldset>
        ...
        <ul>
            <li><label title="CarID" for="carID">Car ID</label><input name="carID" id="carID" type="text" size="20" maxlength="3"/></li>
			...
			<select name="carMake" id="carMake">
			 ...
			 <li><label title="CarModel" for="carModel">Model</label><input name="carModel" id="carModel" type="text" size="20" maxlength="20"/></li>
			...
			<li><label title="CarColor" for="carColor">Color</label><input name='carColor' id="carColor" type="text" size="20" maxlength="20"/></li>
