...
<body>
<h1 style="text-align:center">Lab 6 - Insert Shipper</h1>
<?php
...
<form id="form0" method="post" action="doInsert.php">
	<fieldset>
		<legend>Insert into shippersLab5</legend>
        <ul>
            <li><label title="ShipperID" for="shipperID">Shipper ID</label><input name="shipperID" id="shipperID" type="text" size="20" maxlength="3"/></li>
