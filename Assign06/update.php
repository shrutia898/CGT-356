...
<head>
    ...
    <title>Lab 6 - Insert Shipper</title>
	<style type="text/css">
...
<h1 style="text-align:center">Lab 6 - Update Shipper</h1>
<?php
        ...
        <ul>
            <li><label title="ShipperID" for="shipperIDdis">Shipper ID</label>
            	...
            	<input name="shipperID" id="shipperID" type="hidden" 
					   value="<?php if($num_results != 0){echo(trim($row["ShipperID"] ) );}?>"/></li>
            <li><label title="CompanyName" for="companyName">Company Name</label><input name="companyName" id="companyName" type="text" size="20" maxlength="20"
					value="<?php if($num_results != 0){echo(trim( $row["CompanyName"] ) );}?>"/></li>
            <li><label title="Phone" for="phone">Phone #</label><input name="phone" id="phone" type="text" size="20" maxlength="20" 
					value="<?php if($num_results != 0){echo(trim( $row["Phone"] ) );}?>"/></li>
